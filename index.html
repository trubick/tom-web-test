...
<head>
    <meta charset="utf-8">
    <title>CR Blinds & Shutters</title>
...
<div id="main-container">
    ...
    <div id="epic-section">
        <div id="home-section">
            ...
            <div class="big-icon-text-set">
                ...
                <p>The measuring service, site survey and installation is all carried out by one contact within the
                    company at a convenient time to suit you.
                    This ensures you receive a personalised service and professional relationship from start to
                    finish.</p>
            </div>
            <div class="big-icon-text-set">
    ...
    <div class="epic-section">
        ...
        <div class="sub-sections-container">
            ...
            <div class="sub-section">
                <div class="sub-section-description">
                    <h3>Venetian</h3>
                    <p>The simple and contemporary Venetian Blind perfectly blends style with practicality. Venetian
                        blinds can be
                        provided in a range of finishes, including real wood, faux wood and aluminium with a range
                        of different size
                        slats and colours</p>
                </div>
                <div class="sub-section-image">
            ...
            <div class="sub-section">
                <div class="sub-section-description">
                    ...
                    <p>Pleated blinds have a number of advantages that make them a good choice for window coverings.
                        These blinds
                        come in a wide range of contemporary fabrics including specialist performance fabric options
                        that can
                        control heat and offer a wide range of benefits making them a good choice for south-facing
                        conservatories.
            ...
            <div class="sub-section">
                <div class="sub-section-description">
                    ...
                    <p>The traditional elegance and functionality of a vertical blind makes it the perfect option for
                        your living
                        room, conservatory or home office. Vertical blinds are a timeless window solution that remains
                        sleek and
                        effortlessly smart, whether you opt for a crisp white style or a more distinct pattern this is
                        the timeless
                        classic for any window.</p>
                </div>
                <div class="sub-section-image">
                    <img src="img/vertical-blinds-bedroom.jpeg"/>
                </div>
            </div>
            <div class="sub-section">
                <div class="sub-section-description">
                    <h3>Roller Blinds</h3>
                    <p>Roller blinds come in various different fabric ranges, whether you require the standard roller, a
                        roller with
                        a cassette (hiding the roller mechanism) a standard chain operation, a spring loaded roller
                        blind with
                        cordless controls (i.e. no chain) or a remote controlled battery operated option there is sure
                        to be
                        something to meet your requirements. Roller blinds can be supplied in many different colours and
                        designs to
            ...
            <div class="sub-section">
                <div class="sub-section-description">
                    <h3>Conservatory blinds</h3>
                    <p>
                        Window and roof blinds added to a conservatory allows more control over the light and privacy.
                        Depending on
                        your chosen option, you can choose a neutral design or one of the many coloured or patterned
                        options to add
                        character and a feature to your windows and ceiling. All conservatory blinds are individually
                        measured for a
    ...
    <div class="epic-section">
        ...
        <div id="repairs-section-container">
...
<script src="./js/fullscreen.js" async></script>
</body>
